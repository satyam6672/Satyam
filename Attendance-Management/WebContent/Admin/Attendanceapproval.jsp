...
try{
	...
	PreparedStatement pst=c.prepareStatement("select * from employeeattendance where status=?");
	pst.setString(1,"NO");
	...
	out.println("<tr><th>EmployeeId</th><th>Intime</th><th>Outtime</th><th>Status</th><th>day</th><th>Department</th><th>Timedif</th></tr></thead>");
    ...
    <% 
	out.println("<form method=get action=Statusupdation.jsp>");
	 %>
	<input type=text name=id style=font-size:14pt pattern=[0-9]{3} requied />
	<input type="submit" value="Daycalculation" class="btn-submit3"/>
		<% 
