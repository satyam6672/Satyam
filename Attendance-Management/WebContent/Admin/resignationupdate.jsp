...
PreparedStatement pst=c.prepareStatement("select * from resignation where Status=?");
pst.setString(1,"NOT UPDATED");
...
<div class="head">
<center>
 <h2>Employee Resignation Table<h2>
 </center>
 </div>
</body>
</html>
...
out.println("<tr><th>EmployeeId</th><th>EmployeeName</th><th>Reason For Resignation</th><th>Date of Resignation</th><th>Status</th></tr></thead>");
...
<% 
out.println("<form method=get action=resignationstatus.jsp>");
%>
